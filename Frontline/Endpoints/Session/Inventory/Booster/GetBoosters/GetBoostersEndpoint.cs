...
namespace Frontline.Endpoints.Session.Inventory.Booster.GetBoosters;

public class GetBoostersEndpoint : Endpoint<GetInventoryRequest, List<int>>
{
    private readonly IPlayerRepository _playerRepository;

    public GetBoostersEndpoint(IPlayerRepository playerRepository)
    {
