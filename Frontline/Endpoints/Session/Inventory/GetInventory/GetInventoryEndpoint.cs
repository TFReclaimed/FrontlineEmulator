...
public class GetInventoryEndpoint : Endpoint<GetInventoryRequest, InventoryListResponse>
{
    private readonly IInventoryRepository _inventoryRepository;

    public GetInventoryEndpoint(IInventoryRepository inventoryRepository)
    {
