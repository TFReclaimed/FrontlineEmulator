...
public class SaveDropshipEndpoint : Endpoint<SaveDropshipRequest>
{
    ...
    public SaveDropshipEndpoint(IPlayerRepository playerRepository, IInventoryRepository inventoryRepository,
