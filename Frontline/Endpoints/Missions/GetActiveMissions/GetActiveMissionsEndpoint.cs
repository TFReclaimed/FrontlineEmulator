...
namespace Frontline.Endpoints.Missions.GetActiveMissions;

public class GetActiveMissionsEndpoint : EndpointWithoutRequest<List<MissionStageStatus>>
{
    ...
    public GetActiveMissionsEndpoint(IActiveMissionRepository activeMissionRepository,
